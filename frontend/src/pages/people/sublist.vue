      ...
      <v-container grid-list-xs fluid class="pa-2">
        ...
        >
          ...
          <p class="body-1 mt-2 mb-0 pa-0">
            ...
            <translate
              >You may rescan your library to find additional faces.</translate
            >
            <translate
              >Recognition starts after indexing has been completed.</translate
            >
          </p>
        </v-alert>
        <v-layout
          row
          wrap
          class="search-results subject-results cards-view"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <v-icon color="white" class="select-off"
                    >radio_button_off</v-icon
                  >
                </v-btn>
              ...
              >
                ...
                <div class="caption mb-2">
                  ...
                  <button v-else-if="model.PhotoCount > 0">
                    <translate :translate-params="{ n: model.PhotoCount }"
                      >Contains %{n} pictures.</translate
                    >
                  </button>
                </div>
              </v-card-text>
  ...
  methods: {
    ...
    selectRange(rangeEnd, models) {
      if (
        !models ||
        !models[rangeEnd] ||
        !(models[rangeEnd] instanceof RestModel)
      ) {
